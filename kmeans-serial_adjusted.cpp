...
public:
	...
	void run(vector<Point> & points)
	{
		...
		int iter = 1;
				...
				auto total_1 = std::chrono::duration_cast<std::chrono::microseconds>(begin-begin).count();
				auto total_2 = std::chrono::duration_cast<std::chrono::microseconds>(begin-begin).count();
		while(true)
		{
			bool done = true;
